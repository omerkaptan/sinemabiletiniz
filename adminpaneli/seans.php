...
$sorgu2=mysql_query("insert into seans(seans_tarihi,seans_saati,film_id)values('$bilet_tarihi','$seans','$film_id')");
if ($sorgu2){
...
echo '</script>';
	...
	<form name="form1" method="POST" action="seans.php" enctype="multipart/form-data">
 ...
 <tr>
    ...
    <th height="5" colspan="12" align="center">SEANS EKLE &nbsp;
    ...
    <td width="238"><strong>FİLM</strong></td>
  ...
  <tr>
    ...
    <td height="87" style="text-align: center">
    <select name="film_adi" width="60"id="film_adi">
    <?php 
   ...
   print "<input type='hidden' name='filmID' value='".$id."'/>"; ?></select></td>
      

    
    <td width="201" style="text-align: center"><input type="time"  name="seans"></td>
    <?php
	  $tarih = date("Y-m-d");
    ...
    echo '<td width="46" style="text-align: center"><input name="bilet_tarih" type="date" max='.$tarih2.' min='.$tarih.'  width="60" height="30" '; ?> onBlur="MM_validateForm('filmin_adi','','R','fragman','','R','yonetmen','','R','filmin_oyunculari','','R');return document.MM_returnValue"><td style="text-align: center"></td>
